...
_ES: dict[str, str] = {
    ...
    "output directory for TheDiscDB contribution files": "directorio de salida para archivos de contribución de TheDiscDB",
    ...
    "disc name for a direct TheDiscDB contribution (default: Disc 1)": "nombre de disco para una contribución directa de TheDiscDB (predeterminado: Disc 1)",
    "authenticated TheDiscDB browser cookie (or set THEDISCDB_COOKIE)": "cookie autenticada del navegador para TheDiscDB (o define THEDISCDB_COOKIE)",
